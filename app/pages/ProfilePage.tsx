...
import { User, UserRole, ProviderProfile, VerificationStatus } from '../../lib/types';
import { getUserById, updateUser, getProviderByUserId, updateProviderByUserId } from '../../lib/actions';
import { 
  User as UserIcon, 
  Mail, 
  Phone, 
...
const ProfilePage: React.FC<ProfilePageProps> = ({ user, onUpdateUser }) => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role === UserRole.PROVIDER) {
        await updateProviderByUserId(user.id, {
