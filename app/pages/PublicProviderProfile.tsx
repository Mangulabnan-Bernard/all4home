...
import { getProviderById, getUserById, getReviewsByProviderId } from '../../lib/actions';
import { ProviderProfile, User, Review } from '../../lib/types';
...
const PublicProviderProfile: React.FC<PublicProviderProfileProps> = ({ providerId, onNavigate }) => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const r = await getReviewsByProviderId(providerId);
      setReviews(r);
      setLoading(false);
    };
    loadData();
