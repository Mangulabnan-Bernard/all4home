...
import { getProviders, getUsers, approveProvider } from '../../lib/actions';
import { ProviderProfile, VerificationStatus, BookingStatus, UserRole, User } from '../../lib/types';
import { 
  Users, 
  AlertTriangle, 
  TrendingUp, 
...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setUsers(u.reduce((acc: Record<string, User>, user: User) => ({ ...acc, [user.id]: user }), {} as Record<string, User>));
    };
    load();
  }, []);
